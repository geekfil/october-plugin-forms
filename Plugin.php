...
class Plugin extends PluginBase {
    ...
    public function registerNavigation() {
        ...
        $url = app(BackendHelpers::class)->getBackendURL([
    ...
    public function registerMailTemplates() {
        return [
            'martin.forms::mail.notification' => trans('martin.forms::lang.mails.form_notification.description'),
            'martin.forms::mail.autoresponse' => trans('martin.forms::lang.mails.form_autoresponse.description'),
        ];
    }
